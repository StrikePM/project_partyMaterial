...
public class ActivityCetakCari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Config temp = new Config(getSharedPreferences("config",this.MODE_PRIVATE));
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in = new Intent(ActivityCetakCari.this,StrukPembayaran.class) ;
                                ...
                                for (int i = 0; i < bytesAvailable; i++) {
                                    ...
                                    if (b == delimiter) {
                                        ...
                                        handler.post(new Runnable() {
                                            public void run() {
                                                Toast.makeText(ActivityCetakCari.this, data, Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    } else {
